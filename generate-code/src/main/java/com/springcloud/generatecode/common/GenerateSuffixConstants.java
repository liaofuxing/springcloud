 ...
 */
public class GenerateSuffixConstants {
    ...
    public final static String SERVICE_IMPL_PATH_SUFFIX = "service/impl";
    public final static String SERVICE_IMPL_CLASSPATH_SUFFIX = "service.impl";
    ...
    public final static String POINT_PATH_SUFFIX = ".";

    public final static String PATH_SIGN_SUFFIX = "/";
