...
public class CommodityCategoryServiceImpl implements CommodityCategoryService {
     ...
     */
    @Override
    public CommodityCategory addCommodityCategory(CommodityCategoryDto shopCategoryDto) {
        CommodityCategory shopCategory = new CommodityCategory();
        BeanUtils.copyProperties(shopCategoryDto, shopCategory);
        return commodityCategoryRepository.save(shopCategory);
    }
}
